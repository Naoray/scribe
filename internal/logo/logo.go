...
// logoCompact is the small FIGlet logo with chip motif (~28 chars wide x 8 lines).
// Chip mark sits centered above the block letters, matching the website footer.
const logoCompact = `         .------.
         |##    |
         |   S  |
         '------'
...
// logoTiny is the chip+S motif (8 chars wide x 4 lines), the smallest brand mark.
const logoTiny = `.------.
|##    |
|   S  |
'------'`
